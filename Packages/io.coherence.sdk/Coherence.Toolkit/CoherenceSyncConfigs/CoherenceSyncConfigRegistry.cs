...
namespace Coherence.Toolkit
{
    ...
    public sealed class CoherenceSyncConfigRegistry : PreloadedSingleton<CoherenceSyncConfigRegistry>, IEnumerable<CoherenceSyncConfig>
    {
        ...
        // Key: CoherenceSyncConfig Network Asset ID
        // Value: Associated CoherenceSyncConfig
        ...
        internal bool Register(CoherenceSyncConfig config)
        {
            ...
            var networkAssetId = config.GetNetworkAssetId();

            if (networkIdToConfigDictionary.ContainsKey(networkAssetId))
            {
            ...
            networkIdToConfigDictionary.Add(networkAssetId, config);
#if UNITY_EDITOR
        ...
        internal bool Deregister(string syncGuid)
        {
            ...
            removed &= networkIdToConfigDictionary.Remove(config.GetNetworkAssetId());
