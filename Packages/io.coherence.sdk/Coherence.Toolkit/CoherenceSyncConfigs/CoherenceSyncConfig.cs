...
namespace Coherence.Toolkit
{
    ...
    public sealed class CoherenceSyncConfig : ScriptableObject
    {
        ...
        /// <summary>
        /// Returns a Network Asset ID for this prefab which can be used to identify it over the network.
        /// </summary>
        public int GetNetworkAssetId()
        {
            // Based on Unity's internal string hash function (DJBX33A)
            var v1 = 5381;
            var v2 = v1;
            ...
            return v1 + (v2 * 1566083941);
        }

        /// <summary>
        /// Returns <see cref="GetNetworkAssetId"/> as a human-readable string representation.
        /// </summary>
        public string GetNetworkAssetIdAsString()
        {
            return NetworkAssetIdToString(GetNetworkAssetId());
        }

        /// <summary>
        /// Converts a network asset ID to a human-readable string representation.
        /// </summary>
        public static string NetworkAssetIdToString(int networkAssetId)
        {
            return networkAssetId.ToString("X8");
        }
