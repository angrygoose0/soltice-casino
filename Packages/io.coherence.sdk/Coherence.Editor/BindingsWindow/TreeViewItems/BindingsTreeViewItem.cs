...
namespace Coherence.Editor
{
    ...
    internal abstract class BindingsTreeViewItem : TreeViewItem
    {
        ...
        internal void DrawCell(Rect rect, BindingsWindowState.ColumnContent columnContent, int lodstep)
        {
            ...
            if (columnContent == BindingsWindowState.ColumnContent.Variables)
            {
                DrawLeftBar(contentRect);
            }

            if (columnContent == BindingsWindowState.ColumnContent.Configuration)
            {
            ...
            if (columnContent == BindingsWindowState.ColumnContent.MaxBandwidth)
            {
