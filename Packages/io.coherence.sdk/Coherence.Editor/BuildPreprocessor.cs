...
namespace Coherence.Editor
{
    ...
    internal class BuildPreprocessor : IPreprocessBuildWithReport
    {
        ...
        public void OnPreprocessBuild(BuildReport report)
        {
            ...
            var isDevelopmentMode = GetIsDevelopmentMode();
            Postprocessor.UpdateRuntimeSettings(isDevelopmentMode);

            if (PortalUtil.UploadOnBuild
                // Only auto-upload schemas to the project being built.
                && ProjectSettings.instance.GetActiveProject(isDevelopmentMode) is { } activeProject)
            {
