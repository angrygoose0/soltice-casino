...
#pragma warning restore CS0414
            ...
            public BaseProperties()
            {
                ...
                var ps = ProjectSettings.instance;
                if (ps != null && !string.IsNullOrEmpty(ps.OrganizationId))
                {
                    org_id = ps.OrganizationId; // DEPRECATED: remove this property once we fully migrate to groups
                    groups.OrgID = ps.OrganizationId;
                }
            }
        }
