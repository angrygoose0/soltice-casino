...
namespace Coherence.Serializer.Tests
{
    ...
    public class SerializerTest : CoherenceTest
    {
        ...
        {
            var definition = new Definition();
            _ = CreateTestCommand(definition, target);
        }
        ...
        private SerializedEntityMessage CreateTestCommand(Definition definition)
        {
            ...
            return Serialize.SerializeCommand(
                cmd,
                definition,
                false,
                logger
        ...
        private SerializedEntityMessage CreateTestCommand(Definition definition, MessageTarget messageTarget)
        {
            var entityID = new Entity((Entities.Index)1, 0, false);
            var cmd = definition.CreateAuthorityRequest(
                entityID,
