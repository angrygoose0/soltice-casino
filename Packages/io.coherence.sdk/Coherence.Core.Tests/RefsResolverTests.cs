...
namespace Coherence.Core.Tests
{
    ...
    public class RefsResolverTests : CoherenceTest
    {
        ...
        private Entity entityA = new Entity((Entities.Index)2, 0, false);
        private Entity entityB = new Entity((Entities.Index)4, 0, false);
        private Entity entityC = new Entity((Entities.Index)8, 0, false);
        private Entity entityD = new Entity((Entities.Index)16, 0, false);
