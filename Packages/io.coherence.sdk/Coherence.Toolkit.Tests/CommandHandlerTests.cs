...
namespace Coherence.Toolkit.Tests
{
    ...
    public class CommandHandlerTests : CoherenceTest
    {
        ...
        public override void SetUp()
        {
            ...
            bridgeMock.Setup(bridge => bridge.ClientID).Returns(new ClientID(1));
            ...
            commandsHandler.AddBakedCommand("Coherence.Toolkit.Tests.CommandHandlerTests+MockComponent.C1", "(Coherence.Toolkit.CoherenceSync)",
                _ => { }, _ => { }, MessageTarget.StateAuthorityOnly, mockComponent, false);
        ...
        public void SendCommand_ShouldValidateIfEntitiesAreInitialized_WithCoherenceSync(bool initialized, bool usingReflection)
        {
            ...
            bridgeMock.Setup(bridge => bridge.UnityObjectToEntityId(It.IsAny<CoherenceSync>()))
                .Returns(initialized ? new Entity((Entities.Index)1, 0, Entity.Relative) : Entity.InvalidRelative);

            // Act
            var result = commandsHandler.SendCommand(typeof(MockComponent), nameof(MockComponent.C1), MessageTarget.StateAuthorityOnly, ChannelID.Default, true, cs);
        ...
        public void SendCommand_ShouldValidateIfEntitiesAreInitialized_WithGameObject(bool initialized, bool usingReflection)
        {
            ...
            // Act
            var result = commandsHandler.SendCommand(typeof(MockComponent), nameof(MockComponent.C2), MessageTarget.StateAuthorityOnly, ChannelID.Default, true, cs);
        ...
        public void SendCommand_ShouldValidateIfEntitiesAreInitialized_WithTransform(bool initialized, bool usingReflection)
        {
            ...
            // Act
            var result = commandsHandler.SendCommand(typeof(MockComponent), nameof(MockComponent.C3), MessageTarget.StateAuthorityOnly, ChannelID.Default, true, cs.transform);
        ...
        public void SendCommand_ShouldValidateTupleTypes_WhenOnlyTuplesAndCorrect(bool usingReflection)
        {
            ...
            bridgeMock.Setup(bridge => bridge.UnityObjectToEntityId(It.IsAny<CoherenceSync>()))
                .Returns(new Entity((Entities.Index)1, 0, Entity.Relative));

            // Act
            var result = commandsHandler.SendCommand(typeof(MockComponent), nameof(MockComponent.C1), MessageTarget.StateAuthorityOnly, ChannelID.Default, true, (typeof(CoherenceSync), cs));
        ...
        public void SendCommand_ShouldValidateTupleTypes_WhenOnlyTuplesAndIncorrect(bool usingReflection)
        {
            ...
            // Act
            var result = commandsHandler.SendCommand(typeof(MockComponent), nameof(MockComponent.C1), MessageTarget.StateAuthorityOnly, ChannelID.Default, true, (typeof(Transform), cs));
        ...
        public void SendCommand_ShouldValidateTupleTypes_WhenMixTuplesObjectsAndCorrect(bool usingReflection)
        {
            ...
            // Act
            var result = commandsHandler.SendCommand(typeof(MockComponent), nameof(MockComponent.C4), MessageTarget.StateAuthorityOnly, ChannelID.Default, true, (typeof(Transform), cs.transform), "m");
        ...
        public void SendCommand_ShouldValidateTupleTypes_WhenMixTuplesObjectsAndIncorrect(bool usingReflection)
        {
            ...
            // Act
            var result = commandsHandler.SendCommand(typeof(MockComponent), nameof(MockComponent.C4), MessageTarget.StateAuthorityOnly, ChannelID.Default, true, (typeof(Transform), cs), "m");

            // Assert
            Assert.IsFalse(result);
        }

        [TestCase(MessageTarget.StateAuthorityOnly, true)]
        [TestCase(MessageTarget.StateAuthorityOnly, false)]
