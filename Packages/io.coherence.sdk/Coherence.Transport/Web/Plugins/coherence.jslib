        ...
        var obj = {
                    ...
                    .then(function (res) {
                        if (res.data) {
                            res.data.forEach(function (ice) {
                                console.debug("[WRTC] Remote ICE candidate", ice);
                                obj.peer.addIceCandidate(ice).catch( function (ex) {
                                    console.error("[WRTC] ICE candidate error", ex);
                                } );
                            });
                        }
                    })
            ...
            createOffer: function (url, token, uniqueRoomId, worldId, region) {
                ...
                peer.createOffer()
                    ...
                    .then(function (res) {
                        console.debug("[WRTC] Offer answer", res);
            ...
            connect: function (url, roomId, token, uniqueRoomId, worldId, region, schemaId) {
                ...
                obj.fetchIceServers().then(function() {
                    ...
                    peer.onsignalingstatechange = (event) => { console.debug("[WRTC] Signaling state change", event); };
