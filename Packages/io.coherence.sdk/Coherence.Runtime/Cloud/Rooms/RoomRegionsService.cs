namespace Coherence.Cloud
{
    ...
    public class RoomRegionsService
    {
        ...
        public void FetchRegions(Action<RequestResponse<IReadOnlyList<string>>> onRequestFinished, CancellationToken cancellationToken = default)
        {
        ...
        public async Task<IReadOnlyList<string>> FetchRegionsAsync(CancellationToken cancellationToken = default)
        {
            logger.Trace("FetchRegions - start");
