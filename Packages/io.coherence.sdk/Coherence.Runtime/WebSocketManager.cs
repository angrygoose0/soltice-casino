...
#pragma warning restore CS0414
        ...
        private async Task<bool> ValidateWebSocketParameters()
        {
            ...
            {
                if (requestException.ErrorCode is ErrorCode.RSVersionNotFound or ErrorCode.SchemaNotFound or ErrorCode.ProjectNotFound)
                {
        ...
        private void Backoff()
        {
            ...
            logger.Debug("Backoff", idSource.IdBaseLogParam, ("backoff", connectBackoff));
