...
namespace Coherence
{
    ...
    public class SchemaDefinition
    {
        ...
        public Dictionary<string, EnumDefinition> EnumDefinitions = new();
    }
    ...
    public class EnumDefinition : BaseDefinition
    {
        ...
        public EnumDefinition(string name, string[] names, string[] values, int bits, int min, int max) : base(name)
        {
            this.names = names;
            this.values = values;
            this.bits = bits;
    ...
    public class ComponentMemberDescription
    {
        ...
        public ComponentMemberDescription(string variableName,
            ...
            int fieldOffset,
            bool isEnum,
            DictionaryOfStringString overrides = null)
        {
    ...
    public class CommandDescription
    {
            ...
            string bakeConditional)
        {
            ...
            static string BuildSignature(List<CommandParameterInfo> parameters)
            {
                var sb = new StringBuilder(parameters.Count * 16);
                sb.Append('(');
