...
namespace Blackjack
{
    ...
    public partial class BlackjackClient : TransactionalBaseClient<BlackjackErrorKind>
    {
        ...
        {
            return new Dictionary<uint, ProgramError<BlackjackErrorKind>>{{6000U, new ProgramError<BlackjackErrorKind>(BlackjackErrorKind.Unauthorized, "Unauthorized")}, {6001U, new ProgramError<BlackjackErrorKind>(BlackjackErrorKind.ActionTooSoon, "Too soon to perform dealer action")}, };
        }
    }
    ...
    namespace Program
    {
        ...
        public class DelegateAuthorityAccounts
        {
            ...
            public PublicKey OwnerProgram { get; set; } = new PublicKey("6ra767ieWZJao3phKkAge2pEPH9jHdfWNKTiq3Cw2Lgo");
        ...
        public class FinishGameAccounts
        {
            public PublicKey Signer { get; set; }
        ...
        public class PlayerAnteAccounts
        {
            ...
            public PublicKey TreasuryProgram { get; set; } = new PublicKey("HuqyBcHcwwX72bHJxPSxQaHESvkn2AxDdBc7HaQNU4Qt");
            public PublicKey SystemProgram { get; set; } = new PublicKey("11111111111111111111111111111111");
            public PublicKey MagicProgram { get; set; } = new PublicKey("Magic11111111111111111111111111111111111111");
            public PublicKey MagicContext { get; set; } = new PublicKey("MagicContext1111111111111111111111111111111");
        }
        ...
        {
            public const string ID = "6ra767ieWZJao3phKkAge2pEPH9jHdfWNKTiq3Cw2Lgo";
            ...
            public static Solana.Unity.Rpc.Models.TransactionInstruction FinishGame(FinishGameAccounts accounts, PublicKey programId = null)
            {
                programId ??= new(ID);
                List<Solana.Unity.Rpc.Models.AccountMeta> keys = new()
                ...
                byte[] _data = new byte[1200];
                int offset = 0;
                _data.WriteU64(10521099499619121320UL, offset);
                offset += 8;
                byte[] resultData = new byte[offset];
                Array.Copy(_data, resultData, offset);
                return new Solana.Unity.Rpc.Models.TransactionInstruction{Keys = keys, ProgramId = programId.KeyBytes, Data = resultData};
            ...
            public static Solana.Unity.Rpc.Models.TransactionInstruction PlayerAnte(PlayerAnteAccounts accounts, ulong player_bet, PublicKey programId = null)
            {
                programId ??= new(ID);
                List<Solana.Unity.Rpc.Models.AccountMeta> keys = new()
            ...
            public static Solana.Unity.Rpc.Models.TransactionInstruction PlayerDealCards(PlayerDealCardsAccounts accounts, byte _hand_id, PublicKey programId = null)
            {
                programId ??= new(ID);
                List<Solana.Unity.Rpc.Models.AccountMeta> keys = new()
                {Solana.Unity.Rpc.Models.AccountMeta.Writable(accounts.Signer, true), Solana.Unity.Rpc.Models.AccountMeta.ReadOnly(accounts.Blackjack, false), Solana.Unity.Rpc.Models.AccountMeta.Writable(accounts.BlackjackHand, false), Solana.Unity.Rpc.Models.AccountMeta.ReadOnly(accounts.MagicProgram, false), Solana.Unity.Rpc.Models.AccountMeta.Writable(accounts.MagicContext, false)};
            ...
            public static Solana.Unity.Rpc.Models.TransactionInstruction PlayerSplit(PlayerSplitAccounts accounts, byte _hand_id, PublicKey programId = null)
            {
                programId ??= new(ID);
                List<Solana.Unity.Rpc.Models.AccountMeta> keys = new()
            ...
            public static Solana.Unity.Rpc.Models.TransactionInstruction SettleHand(SettleHandAccounts accounts, byte _hand_id, PublicKey programId = null)
            {
                programId ??= new(ID);
                List<Solana.Unity.Rpc.Models.AccountMeta> keys = new()
                {Solana.Unity.Rpc.Models.AccountMeta.Writable(accounts.Signer, true), Solana.Unity.Rpc.Models.AccountMeta.Writable(accounts.Blackjack, false), Solana.Unity.Rpc.Models.AccountMeta.Writable(accounts.BlackjackHand, false), Solana.Unity.Rpc.Models.AccountMeta.Writable(accounts.Authority, false), Solana.Unity.Rpc.Models.AccountMeta.Writable(accounts.UserBalance, false), Solana.Unity.Rpc.Models.AccountMeta.Writable(accounts.Treasury, false), Solana.Unity.Rpc.Models.AccountMeta.Writable(accounts.TreasuryTokenAccount, false), Solana.Unity.Rpc.Models.AccountMeta.ReadOnly(accounts.TreasuryProgram, false), Solana.Unity.Rpc.Models.AccountMeta.ReadOnly(accounts.SystemProgram, false), Solana.Unity.Rpc.Models.AccountMeta.ReadOnly(accounts.MagicProgram, false), Solana.Unity.Rpc.Models.AccountMeta.Writable(accounts.MagicContext, false)};
