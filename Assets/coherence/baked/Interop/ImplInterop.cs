    ...
    public class DataInteropHandler : IDataInteropHandler
    {
        ...
        public unsafe void UpdateComponent(INativeCoreComponentUpdater updater, InteropEntity entity, ICoherenceComponentData component)
        {
            ...
            switch (componentType)
            {
                ...
                case 18:
                {
                    var orig = (_60786269438aa4c6c8c3c4f9b60e4b9b_3871810461409951791)component;
                    var val = new _60786269438aa4c6c8c3c4f9b60e4b9b_3871810461409951791.Interop();

                    val.target = orig.target;
                    val.trailDuration = orig.trailDuration;
